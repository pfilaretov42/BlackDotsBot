...
public class VideoAction implements Consumer<Update> {
    ...
    public void accept(Update update) {
        ...
        List<Note> notes = parse(text);



        File file = generateVideo();
    ...
    private List<Note> parse(String text) {
    ...
    private void play(IContainer audioContainer, IStreamCoder audioCoder, int audioStreamIndex,
        IMediaWriter writer, int videoStreamIndex, int videoAudioStreamIndex, BufferedImage backgroundImage, long startTime, int duration) {
